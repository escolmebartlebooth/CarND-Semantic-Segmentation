...
def test_for_kitti_dataset(data_dir):
    ...
    assert training_images_count == 259, 'Expected 289 training images, found {} images.'.format(training_images_count)
    assert training_labels_count == 259, 'Expected 289 training labels, found {} labels.'.format(training_labels_count)
